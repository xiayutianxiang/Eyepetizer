...
object GlobalUtil {
     ...
     */
    fun getString(resId: Int): String = BaseApplication.getContext().resources.getString(resId)
     ...
     * @return 字符串资源id对应的字符串内容。
     */
    fun getDimension(resId: Int): Int = BaseApplication.getContext().resources.getDimensionPixelOffset(resId)
     ...
     * @return 指定资源名的资源id。
     */
    fun getResourceId(name: String, type: String): Int = BaseApplication.getContext().resources.getIdentifier(name, type, appPackage)
    ...
    fun getApplicationMetaData(key: String): String? {
        ...
        try {
            applicationInfo = BaseApplication.getContext().packageManager.getApplicationInfo(appPackage, PackageManager.GET_META_DATA)
