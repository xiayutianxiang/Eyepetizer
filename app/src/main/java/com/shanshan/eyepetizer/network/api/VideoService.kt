...
import com.shanshan.eyepetizer.data.VideoBeanForClient
import com.shanshan.eyepetizer.data.VideoRelated
import com.shanshan.eyepetizer.data.VideoReplies
...
interface VideoService {
    ...
    companion object {
         ...
         * 视频详情-评论列表URL
         */
        const val VIDEO_REPLIES_URL = "${Constants.WebUrl.BASE_URL}api/v2/replies/video?videoId="
    }
